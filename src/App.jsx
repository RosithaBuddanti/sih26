...
function AppContent() {
    ...
    const handleScroll = () => {
      ...
      if (
        ...
        const clampedY = Math.max(
          30,
          Math.min(totalHeight - 30, currentProgress)
        );
  ...
  useEffect(() => {
    const handleDragMove = (e) => {
      ...
      const clampedY = Math.max(
        30,
        Math.min(totalHeight - 30, relativeY)
      );
  ...
  // Always render the main website
  return (
    <div className="min-h-screen bg-[#070709] text-slate-100 transition-colors duration-300 font-sans selection:bg-amber-500 selection:text-slate-950">
      ...
      <main>
        ...
        >
          ...
          {/* =====================================================
              CONTINUOUS INTERACTIVE OIL ROPE LINE
              Z-INDEX REDUCED SO CONTENT APPEARS ABOVE IT
          ===================================================== */}
          ...
          {/* =====================================================
              DYNAMIC DRAGGABLE PERSON HANGING ON ROPE
              Z-INDEX REDUCED SO CONTENT APPEARS ABOVE IT
          ===================================================== */}
          ...
          >
            ...
            >
              ...
              {/* PERSON HANGING ON THE ROPE WITH SWAYING ANIMATION */}
      ...
      {/* Interactive AI SIF Demo Simulator Modal */}
